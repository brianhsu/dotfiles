...
${font}${offset 60}${voffset -30}${cpugraph cpu0 20,25 #00CCCC}
...
${color grey}${offset 620}${voffset -15}${downspeedgraph 20,25 #00CCCC}
${offset 665}${voffset -28}${font1}${color #FBA922}󰅧 UP
${color grey}${offset 715}${voffset -15}${upspeedgraph 20,25 #FBA922}
