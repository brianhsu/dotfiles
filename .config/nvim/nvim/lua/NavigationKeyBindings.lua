...
-- 用 SHFIT + 方向鍵或 IJKL 來選擇頁籤
vim.keymap.set('n', '<S-LEFT>', '<ESC><CMD>:tabprevious<CR>', { desc = 'Switch to previous tab' })
vim.keymap.set('n', '<S-j>', '<ESC><CMD>:tabprevious<CR>', { desc = 'Switch to previous tab' })
vim.keymap.set('n', '<S-RIGHT>', '<ESC><CMD>:tabnext<CR>', { desc = 'Switch to next tab.' })
vim.keymap.set('n', '<S-l>', '<ESC><CMD>:tabnext<CR>', { desc = 'Switch to next tab.' })
